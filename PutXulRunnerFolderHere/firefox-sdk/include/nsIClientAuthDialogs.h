...
class NS_NO_VTABLE nsIClientAuthDialogs : public nsISupports {
 public:
  ...
  NS_IMETHOD ChooseCertificate(nsIInterfaceRequestor *ctx, const nsACString & hostname, int32_t port, const nsACString & organization, const nsACString & issuerOrg, nsIArray *certList, uint32_t *selectedIndex, bool *_retval) = 0;
...
#define NS_DECL_NSICLIENTAUTHDIALOGS \
  NS_IMETHOD ChooseCertificate(nsIInterfaceRequestor *ctx, const nsACString & hostname, int32_t port, const nsACString & organization, const nsACString & issuerOrg, nsIArray *certList, uint32_t *selectedIndex, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICLIENTAUTHDIALOGS \
  NS_METHOD ChooseCertificate(nsIInterfaceRequestor *ctx, const nsACString & hostname, int32_t port, const nsACString & organization, const nsACString & issuerOrg, nsIArray *certList, uint32_t *selectedIndex, bool *_retval); 
...
/* boolean chooseCertificate (in nsIInterfaceRequestor ctx, in AUTF8String hostname, in long port, in AUTF8String organization, in AUTF8String issuerOrg, in nsIArray certList, out unsigned long selectedIndex); */
NS_IMETHODIMP nsClientAuthDialogs::ChooseCertificate(nsIInterfaceRequestor *ctx, const nsACString & hostname, int32_t port, const nsACString & organization, const nsACString & issuerOrg, nsIArray *certList, uint32_t *selectedIndex, bool *_retval)
{
