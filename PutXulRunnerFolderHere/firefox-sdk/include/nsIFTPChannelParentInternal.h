/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl\nsIFTPChannelParentInternal.idl
 */
...
#define NS_DECL_NON_VIRTUAL_NSIFTPCHANNELPARENTINTERNAL \
  NS_METHOD SetErrorMsg(const char * msg, bool useUTF8); 
...
/* Header file */
class nsFTPChannelParentInternal : public nsIFTPChannelParentInternal
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIFTPCHANNELPARENTINTERNAL

  nsFTPChannelParentInternal();
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsFTPChannelParentInternal, nsIFTPChannelParentInternal)

nsFTPChannelParentInternal::nsFTPChannelParentInternal()
{
...
/* void setErrorMsg (in string msg, in boolean useUTF8); */
NS_IMETHODIMP nsFTPChannelParentInternal::SetErrorMsg(const char * msg, bool useUTF8)
{
