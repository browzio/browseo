...
namespace SharedWorkerBinding {

  typedef mozilla::dom::workers::SharedWorker NativeType;
  ...
  bool
  Wrap(JSContext* aCx, mozilla::dom::workers::SharedWorker* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
