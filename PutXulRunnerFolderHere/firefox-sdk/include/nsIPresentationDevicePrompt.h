/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl\nsIPresentationDevicePrompt.idl
 */
...
class NS_NO_VTABLE nsIPresentationDeviceRequest : public nsISupports {
 public:
  ...
  NS_IMETHOD GetRequestURLs(nsIArray * *aRequestURLs) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIPRESENTATIONDEVICEREQUEST \
  ...
  NS_METHOD GetRequestURLs(nsIArray * *aRequestURLs); \
  ...
  NS_METHOD Cancel(nsresult reason); 
...
/* readonly attribute nsIArray requestURLs; */
NS_IMETHODIMP nsPresentationDeviceRequest::GetRequestURLs(nsIArray * *aRequestURLs)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute nsIDOMEventTarget chromeEventHandler; */
NS_IMETHODIMP nsPresentationDeviceRequest::GetChromeEventHandler(nsIDOMEventTarget * *aChromeEventHandler)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute nsIPrincipal principal; */
NS_IMETHODIMP nsPresentationDeviceRequest::GetPrincipal(nsIPrincipal * *aPrincipal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void cancel (in nsresult reason); */
NS_IMETHODIMP nsPresentationDeviceRequest::Cancel(nsresult reason)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
