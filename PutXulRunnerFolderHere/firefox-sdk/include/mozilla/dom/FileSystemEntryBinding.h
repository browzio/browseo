...
#ifndef mozilla_dom_FileSystemEntryBinding_h
#define mozilla_dom_FileSystemEntryBinding_h
...
namespace FileSystemEntryBinding {

  typedef mozilla::dom::FileSystemEntry NativeType;
...
#endif // mozilla_dom_FileSystemEntryBinding_h
