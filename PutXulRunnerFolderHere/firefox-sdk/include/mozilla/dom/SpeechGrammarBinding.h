...
#ifndef mozilla_dom_SpeechGrammarBinding_h
#define mozilla_dom_SpeechGrammarBinding_h
...
namespace SpeechGrammarBinding {

  typedef mozilla::dom::SpeechGrammar NativeType;
...
#endif // mozilla_dom_SpeechGrammarBinding_h
