...
#ifndef mozilla_dom_SpeechRecognitionBinding_h
#define mozilla_dom_SpeechRecognitionBinding_h
...
namespace SpeechRecognitionBinding {

  typedef mozilla::dom::SpeechRecognition NativeType;
...
#endif // mozilla_dom_SpeechRecognitionBinding_h
