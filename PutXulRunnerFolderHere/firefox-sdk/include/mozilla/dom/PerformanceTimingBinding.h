...
#ifndef mozilla_dom_PerformanceTimingBinding_h
#define mozilla_dom_PerformanceTimingBinding_h
...
namespace PerformanceTimingBinding {
  ...
  typedef mozilla::dom::PerformanceTiming NativeType;

  bool
  JsonifyAttributes(JSContext* aCx, JS::Handle<JSObject*> obj, mozilla::dom::PerformanceTiming* self, JS::Rooted<JSObject*>& aResult);
...
#endif // mozilla_dom_PerformanceTimingBinding_h
