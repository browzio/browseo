...
class NS_NO_VTABLE nsIWebNavigation : public nsISupports {
 public:
  ...
  NS_IMETHOD SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes) = 0;
...
#define NS_DECL_NSIWEBNAVIGATION \
  ...
  NS_IMETHOD SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIWEBNAVIGATION \
  ...
  NS_METHOD SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes); 
...
#define NS_FORWARD_NSIWEBNAVIGATION(_to) \
  ...
  NS_IMETHOD SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes) override { return _to SetOriginAttributesBeforeLoading(originAttributes); } 
...
#define NS_FORWARD_SAFE_NSIWEBNAVIGATION(_to) \
  ...
  NS_IMETHOD SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOriginAttributesBeforeLoading(originAttributes); } 
...
/* void setOriginAttributesBeforeLoading (in jsval originAttributes); */
NS_IMETHODIMP nsWebNavigation::SetOriginAttributesBeforeLoading(JS::HandleValue originAttributes)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
