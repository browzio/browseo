...
class NS_NO_VTABLE nsIChildChannel : public nsISupports {
 public:
  ...
  NS_IMETHOD ConnectParent(uint32_t registrarId) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSICHILDCHANNEL \
  NS_METHOD ConnectParent(uint32_t registrarId); \
...
/* void connectParent (in uint32_t registrarId); */
NS_IMETHODIMP nsChildChannel::ConnectParent(uint32_t registrarId)
{
