...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsISimpleStreamListener.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsISimpleStreamListener : nsIStreamListener
	{
		...
		/// </summary>
		/// <param name="aSink">
		/// data will be read from the channel to this output stream.
		/// Must implement writeFrom.
		/// </param>
		/// <param name="aObserver">
		/// optional stream observer (can be NULL)
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
