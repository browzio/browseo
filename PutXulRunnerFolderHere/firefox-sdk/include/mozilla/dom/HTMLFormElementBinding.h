...
#ifndef mozilla_dom_HTMLFormElementBinding_h
#define mozilla_dom_HTMLFormElementBinding_h
...
namespace HTMLFormElementBinding {

  typedef mozilla::dom::HTMLFormElement NativeType;
...
#endif // mozilla_dom_HTMLFormElementBinding_h
