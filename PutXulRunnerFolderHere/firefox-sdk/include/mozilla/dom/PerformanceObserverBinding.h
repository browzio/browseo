...
{
  MOZ_INIT_OUTSIDE_CTOR Sequence<nsString> mEntryTypes;
...
public:
  ...
  explicit inline PerformanceObserverCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackFunction(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
    MOZ_ASSERT(JS::IsCallable(mCallback));
  }

  explicit inline PerformanceObserverCallback(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
...
{
public:
  explicit inline FastPerformanceObserverCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : PerformanceObserverCallback(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }
  ...
  {
    PerformanceObserverCallback::HoldJSObjectsIfMoreThanOneOwner();
  }
};
} // namespace binding_detail
