...
class NS_NO_VTABLE imgICache : public nsISupports {
 public:
  ...
  MOZ_MUST_USE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval) = 0;
...
#define NS_DECL_IMGICACHE \
  ...
  MOZ_MUST_USE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_IMGICACHE \
  ...
  MOZ_MUST_USE NS_METHOD FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval); \
...
#define NS_FORWARD_IMGICACHE(_to) \
  ...
  MOZ_MUST_USE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval) override { return _to FindEntryProperties(uri, doc, _retval); } \
...
#define NS_FORWARD_SAFE_IMGICACHE(_to) \
  ...
  MOZ_MUST_USE NS_IMETHOD FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->FindEntryProperties(uri, doc, _retval); } \
...
/* [must_use] nsIProperties findEntryProperties (in nsIURI uri, [optional] in nsIDOMDocument doc); */
MOZ_MUST_USE NS_IMETHODIMP _MYCLASS_::FindEntryProperties(nsIURI *uri, nsIDOMDocument *doc, nsIProperties * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
