...
#ifndef mozilla_dom_IDBMutableFileBinding_h
#define mozilla_dom_IDBMutableFileBinding_h
...
namespace IDBMutableFileBinding {

  typedef mozilla::dom::IDBMutableFile NativeType;
...
#endif // mozilla_dom_IDBMutableFileBinding_h
