...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIWindowDataSource.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIWindowDataSource
	{
		...
		nsIDOMWindow GetWindowForResource([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(StringMarshaler))] string inResource);
	}
}
