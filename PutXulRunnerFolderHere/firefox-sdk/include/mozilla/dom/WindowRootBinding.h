...
#ifndef mozilla_dom_WindowRootBinding_h
#define mozilla_dom_WindowRootBinding_h
...
namespace WindowRootBinding {

  typedef nsWindowRoot NativeType;
...
#endif // mozilla_dom_WindowRootBinding_h
