...
#define NS_DECL_NON_VIRTUAL_NSICONTENTVIEWER \
  ...
  NS_METHOD GetLoadCompleted(bool *aLoadCompleted); \
  ...
  NS_METHOD SetBoundsWithFlags(const nsIntRect & aBounds, uint32_t aFlags); \
  ...
  NS_METHOD GetOverrideDPPX(float *aOverrideDPPX); \
  NS_METHOD SetOverrideDPPX(float aOverrideDPPX); \
  ...
  NS_METHOD GetContentSizeConstrained(int32_t maxWidth, int32_t maxHeight, int32_t *width, int32_t *height); \
...
/* [noscript] readonly attribute boolean loadCompleted; */
NS_IMETHODIMP nsContentViewer::GetLoadCompleted(bool *aLoadCompleted)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] void setBoundsWithFlags ([const] in nsIntRectRef aBounds, in unsigned long aFlags); */
NS_IMETHODIMP nsContentViewer::SetBoundsWithFlags(const nsIntRect & aBounds, uint32_t aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute float overrideDPPX; */
NS_IMETHODIMP nsContentViewer::GetOverrideDPPX(float *aOverrideDPPX)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsContentViewer::SetOverrideDPPX(float aOverrideDPPX)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getContentSizeConstrained (in long maxWidth, in long maxHeight, out long width, out long height); */
NS_IMETHODIMP nsContentViewer::GetContentSizeConstrained(int32_t maxWidth, int32_t maxHeight, int32_t *width, int32_t *height)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
