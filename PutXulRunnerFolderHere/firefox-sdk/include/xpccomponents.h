...
class NS_NO_VTABLE nsIXPCComponents_Utils : public nsISupports {
 public:
  ...
  NS_IMETHOD AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_IMETHOD AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_METHOD AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx); \
...
#define NS_FORWARD_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_IMETHOD AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx) override { return _to AllowCPOWsInAddon(addonId, allow, cx); } \
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_IMETHOD AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AllowCPOWsInAddon(addonId, allow, cx); } \
...
/* [implicit_jscontext] void allowCPOWsInAddon (in ACString addonId, in bool allow); */
NS_IMETHODIMP nsXPCComponents_Utils::AllowCPOWsInAddon(const nsACString & addonId, bool allow, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
