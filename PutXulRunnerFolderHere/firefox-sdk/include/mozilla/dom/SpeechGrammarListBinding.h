...
#ifndef mozilla_dom_SpeechGrammarListBinding_h
#define mozilla_dom_SpeechGrammarListBinding_h
...
namespace SpeechGrammarListBinding {

  typedef mozilla::dom::SpeechGrammarList NativeType;
...
#endif // mozilla_dom_SpeechGrammarListBinding_h
