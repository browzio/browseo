...
#ifndef mozilla_dom_OffscreenCanvasBinding_h
#define mozilla_dom_OffscreenCanvasBinding_h
...
namespace OffscreenCanvasBinding {

  typedef mozilla::dom::OffscreenCanvas NativeType;
...
#endif // mozilla_dom_OffscreenCanvasBinding_h
