...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsITreeSelection.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsITreeSelection
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetTreeAttribute([MarshalAs(UnmanagedType.Interface)] nsITreeBoxObject value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetSelectEventsSuppressedAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCurrentColumnAttribute([MarshalAs(UnmanagedType.Interface)] nsITreeColumn value);
	...
	public interface nsINativeTreeSelection : nsITreeSelection
	{
		...
		#region nsITreeSelection Members
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetTreeAttribute([MarshalAs(UnmanagedType.Interface)] nsITreeBoxObject value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetSelectEventsSuppressedAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetCurrentIndexAttribute(int value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetCurrentColumnAttribute([MarshalAs(UnmanagedType.Interface)] nsITreeColumn value);
