...
#define NS_DECL_NON_VIRTUAL_NSIASYNCSHUTDOWNSERVICE \
  ...
  NS_METHOD GetXpcomWillShutdown(nsIAsyncShutdownClient * *aXpcomWillShutdown); 
...
/* readonly attribute nsIAsyncShutdownClient xpcomWillShutdown; */
NS_IMETHODIMP nsAsyncShutdownService::GetXpcomWillShutdown(nsIAsyncShutdownClient * *aXpcomWillShutdown)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
