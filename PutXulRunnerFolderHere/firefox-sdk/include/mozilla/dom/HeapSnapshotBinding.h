...
#ifndef mozilla_dom_HeapSnapshotBinding_h
#define mozilla_dom_HeapSnapshotBinding_h
...
namespace HeapSnapshotBinding {

  typedef mozilla::devtools::HeapSnapshot NativeType;
...
#endif // mozilla_dom_HeapSnapshotBinding_h
