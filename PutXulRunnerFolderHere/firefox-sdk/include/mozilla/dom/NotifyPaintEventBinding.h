...
#ifndef mozilla_dom_NotifyPaintEventBinding_h
#define mozilla_dom_NotifyPaintEventBinding_h
...
namespace NotifyPaintEventBinding {
  ...
  typedef mozilla::dom::NotifyPaintEvent NativeType;
...
#endif // mozilla_dom_NotifyPaintEventBinding_h
