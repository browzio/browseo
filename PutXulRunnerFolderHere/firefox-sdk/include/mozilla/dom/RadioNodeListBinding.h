...
#ifndef mozilla_dom_RadioNodeListBinding_h
#define mozilla_dom_RadioNodeListBinding_h
...
namespace RadioNodeListBinding {

  typedef mozilla::dom::RadioNodeList NativeType;
...
#endif // mozilla_dom_RadioNodeListBinding_h
