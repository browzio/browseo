...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIApplicationCacheContainer.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIApplicationCacheContainer
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetApplicationCacheAttribute([MarshalAs(UnmanagedType.Interface)] nsIApplicationCache value);
	}
}
