...
#ifndef mozilla_dom_SVGNumberBinding_h
#define mozilla_dom_SVGNumberBinding_h
...
namespace SVGNumberBinding {
  ...
  typedef mozilla::DOMSVGNumber NativeType;
...
#endif // mozilla_dom_SVGNumberBinding_h
