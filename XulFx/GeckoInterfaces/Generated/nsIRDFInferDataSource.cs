...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIRDFInferDataSource.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIRDFInferDataSource : nsIRDFDataSource
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetBaseDataSourceAttribute([MarshalAs(UnmanagedType.Interface)] nsIRDFDataSource value);
	}
}
