...
class NS_NO_VTABLE nsIQueryContentEventResult : public nsISupports {
 public:
  ...
  NS_IMETHOD GetCharacterRect(int32_t offset, int32_t *left, int32_t *top, int32_t *width, int32_t *height) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIQUERYCONTENTEVENTRESULT \
  ...
  NS_METHOD GetCharacterRect(int32_t offset, int32_t *left, int32_t *top, int32_t *width, int32_t *height); \
...
/* void getCharacterRect (in long offset, out long left, out long top, out long width, out long height); */
NS_IMETHODIMP nsQueryContentEventResult::GetCharacterRect(int32_t offset, int32_t *left, int32_t *top, int32_t *width, int32_t *height)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
