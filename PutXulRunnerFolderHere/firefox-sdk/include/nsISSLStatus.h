...
class NS_NO_VTABLE nsISSLStatus : public nsISupports {
 public:
  ...
  enum {
    ...
    CERTIFICATE_TRANSPARENCY_NONE = 1,
    CERTIFICATE_TRANSPARENCY_OK = 2,
    CERTIFICATE_TRANSPARENCY_UNKNOWN_LOG = 3,
    CERTIFICATE_TRANSPARENCY_INVALID = 4
  };

  /* readonly attribute unsigned short certificateTransparencyStatus; */
  NS_IMETHOD GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus) = 0;
...
#define NS_DECL_NSISSLSTATUS \
  ...
  NS_IMETHOD GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus) override; \
...
#define NS_DECL_NON_VIRTUAL_NSISSLSTATUS \
  ...
  NS_METHOD GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus); \
...
#define NS_FORWARD_NSISSLSTATUS(_to) \
  ...
  NS_IMETHOD GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus) override { return _to GetCertificateTransparencyStatus(aCertificateTransparencyStatus); } \
...
#define NS_FORWARD_SAFE_NSISSLSTATUS(_to) \
  ...
  NS_IMETHOD GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCertificateTransparencyStatus(aCertificateTransparencyStatus); } \
...
/* readonly attribute unsigned short certificateTransparencyStatus; */
NS_IMETHODIMP nsSSLStatus::GetCertificateTransparencyStatus(uint16_t *aCertificateTransparencyStatus)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
