...
/* [noscript] void SerializeToPrintData (in nsIPrintSettings aPrintSettings, in nsIWebBrowserPrint aWebBrowserPrint, in PrintDataPtr data); */
NS_IMETHODIMP nsPrintSettingsService::SerializeToPrintData(nsIPrintSettings *aPrintSettings, nsIWebBrowserPrint *aWebBrowserPrint, mozilla::embedding::PrintData *data)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] void DeserializeToPrintSettings (in PrintDataRef data, in nsIPrintSettings aPrintSettings); */
NS_IMETHODIMP nsPrintSettingsService::DeserializeToPrintSettings(const mozilla::embedding::PrintData & data, nsIPrintSettings *aPrintSettings)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
