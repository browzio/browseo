...
#ifndef mozilla_dom_MediaDevicesBinding_h
#define mozilla_dom_MediaDevicesBinding_h
...
namespace MediaDevicesBinding {

  typedef mozilla::dom::MediaDevices NativeType;
...
#endif // mozilla_dom_MediaDevicesBinding_h
