...
namespace Gecko
{
	...
	public static class nsString
	{
		...
		public static void Set<T1, T2>(Action<T1, nsAString, T2> func, T1 value1, string stringValue, T2 value2)
		{
	...
	public struct nsStringContainer
	{
...
#pragma warning restore 169
		...
		{
			get { return IntPtr.Size + 4 + 4; }
		}
	}

	#region nsAUTF8String
	[StructLayout(LayoutKind.Sequential)]
	public abstract class nsAUTF8StringBase
		: IString, IDisposable
	{
		private IntPtr _container;

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern int NS_CStringContainerInit(IntPtr container);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern int NS_CStringSetData(IntPtr str, byte[] data, int length);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern int NS_CStringGetData(IntPtr str, out IntPtr data, IntPtr nullTerm);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern int NS_CStringContainerFinish(IntPtr container);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.Bool)]
		protected static extern bool NS_CStringGetIsVoid(IntPtr str);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern void NS_CStringSetIsVoid(IntPtr str, [MarshalAs(UnmanagedType.U1)] bool isVoid);


		protected nsAUTF8StringBase(IntPtr container)
		{
		...
		{
			IntPtr data;
			int length = NS_CStringGetData(this.Container, out data, IntPtr.Zero);
		...
		public virtual void SetData(string value)
		{
			if (value != null)
			{
				...
				NS_CStringSetData(this.Container, utf8, utf8.Length);
			}
			else
			{
				NS_CStringSetIsVoid(this.Container, true);
			}
			GC.KeepAlive(this);
		}
		...
		public override string ToString()
		{
			...
			if (NS_CStringGetIsVoid(this.Container))
			{
				return null;
			}
			GC.KeepAlive(this);
	...
	[StructLayout(LayoutKind.Sequential)]
	public sealed class nsAUTF8String : nsAUTF8StringBase
	{
		private bool _isNative;

		public nsAUTF8String()
			: base(Xpcom.Alloc(nsStringContainer.Size))
		{
			NS_CStringContainerInit(this.Container);
		}

		public nsAUTF8String(IntPtr container)
			: base(container)
		{
			_isNative = true;
			GC.SuppressFinalize(this);
		...
		{
			if (!_isNative && !this.IsDisposed)
			{
				NS_CStringContainerFinish(this.Container);
	...
	#region nsACString
	[StructLayout(LayoutKind.Sequential)]
	public abstract class nsACStringBase
		: IString, IDisposable
	{
		private IntPtr _container;
		...
		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected static extern int NS_CStringSetData(IntPtr str, string data, int length);

		[DllImport(NativeMethods.XPCOM, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		protected internal static extern int NS_CStringGetData(IntPtr str, out IntPtr data, IntPtr nullTerm);
		...
		protected nsACStringBase(IntPtr container)
		{
			_container = container;
		}
		...
		public virtual void SetData(string value)
		{
			if (value != null)
			{
				NS_CStringSetData(this.Container, value, value.Length);
			}
			else
			{
				NS_CStringSetIsVoid(this.Container, true);
	...
	[StructLayout(LayoutKind.Sequential)]
	public sealed class nsACString : nsACStringBase
	{
		private bool _isNative;
		...
		public nsACString(IntPtr container)
			: base(container)
		{
			_isNative = true;
			GC.SuppressFinalize(this);
