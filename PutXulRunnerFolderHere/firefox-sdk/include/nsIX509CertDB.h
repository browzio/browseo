...
class NS_NO_VTABLE nsICertVerificationCallback : public nsISupports {
 public:
  ...
  NS_IMETHOD VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy) = 0;
...
#define NS_DECL_NSICERTVERIFICATIONCALLBACK \
  NS_IMETHOD VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSICERTVERIFICATIONCALLBACK \
  NS_METHOD VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICERTVERIFICATIONCALLBACK(_to) \
  NS_IMETHOD VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy) override { return _to VerifyCertFinished(aPRErrorCode, aVerifiedChain, aHasEVPolicy); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICERTVERIFICATIONCALLBACK(_to) \
  NS_IMETHOD VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy) override { return !_to ? NS_ERROR_NULL_POINTER : _to->VerifyCertFinished(aPRErrorCode, aVerifiedChain, aHasEVPolicy); } 

#if 0
/* Use the code below as a template for the implementation class for this interface. */

/* Header file */
class nsCertVerificationCallback : public nsICertVerificationCallback
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSICERTVERIFICATIONCALLBACK

  nsCertVerificationCallback();
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsCertVerificationCallback, nsICertVerificationCallback)

nsCertVerificationCallback::nsCertVerificationCallback()
{
  /* member initializers and constructor code */
}
...
/* void verifyCertFinished (in int32_t aPRErrorCode, in nsIX509CertList aVerifiedChain, in bool aHasEVPolicy); */
NS_IMETHODIMP nsCertVerificationCallback::VerifyCertFinished(int32_t aPRErrorCode, nsIX509CertList *aVerifiedChain, bool aHasEVPolicy)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIX509CertDB : public nsISupports {
 public:
  ...
  NS_IMETHOD SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString) = 0;
  ...
  NS_IMETHOD ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval) = 0;
  ...
  NS_IMETHOD AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName) = 0;
  ...
  /* void asyncVerifyCertAtTime (in nsIX509Cert aCert, in int64_t aUsage, in uint32_t aFlags, in string aHostname, in uint64_t aTime, in nsICertVerificationCallback aCallback); */
  NS_IMETHOD AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback) = 0;

  /* void clearOCSPCache (); */
  NS_IMETHOD ClearOCSPCache(void) = 0;

  /* void addCertFromBase64 (in ACString base64, in ACString aTrust, in AUTF8String aName); */
  NS_IMETHOD AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName) = 0;

  /* nsIX509CertList getCerts (); */
  NS_IMETHOD GetCerts(nsIX509CertList * *_retval) = 0;

  /* nsIX509CertList getEnterpriseRoots (); */
  NS_IMETHOD GetEnterpriseRoots(nsIX509CertList * *_retval) = 0;
...
#define NS_DECL_NSIX509CERTDB \
  ...
  NS_IMETHOD SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString) override; \
  ...
  NS_IMETHOD ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval) override; \
  ...
  NS_IMETHOD AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName) override; \
  ...
  NS_IMETHOD AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback) override; \
  NS_IMETHOD ClearOCSPCache(void) override; \
  NS_IMETHOD AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName) override; \
  NS_IMETHOD GetCerts(nsIX509CertList * *_retval) override; \
  NS_IMETHOD GetEnterpriseRoots(nsIX509CertList * *_retval) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIX509CERTDB \
  ...
  NS_METHOD SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString); \
  ...
  NS_METHOD ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval); \
  ...
  NS_METHOD AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName); \
  ...
  NS_METHOD AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback); \
  NS_METHOD ClearOCSPCache(void); \
  NS_METHOD AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName); \
  NS_METHOD GetCerts(nsIX509CertList * *_retval); \
  NS_METHOD GetEnterpriseRoots(nsIX509CertList * *_retval); 
...
#define NS_FORWARD_NSIX509CERTDB(_to) \
  ...
  NS_IMETHOD SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString) override { return _to SetCertTrustFromString(cert, trustString); } \
  ...
  NS_IMETHOD ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval) override { return _to ConstructX509FromBase64(base64, _retval); } \
  ...
  NS_IMETHOD AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName) override { return _to AddCert(certDER, aTrust, aName); } \
  ...
  NS_IMETHOD AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback) override { return _to AsyncVerifyCertAtTime(aCert, aUsage, aFlags, aHostname, aTime, aCallback); } \
  NS_IMETHOD ClearOCSPCache(void) override { return _to ClearOCSPCache(); } \
  NS_IMETHOD AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName) override { return _to AddCertFromBase64(base64, aTrust, aName); } \
  NS_IMETHOD GetCerts(nsIX509CertList * *_retval) override { return _to GetCerts(_retval); } \
  NS_IMETHOD GetEnterpriseRoots(nsIX509CertList * *_retval) override { return _to GetEnterpriseRoots(_retval); } 
...
#define NS_FORWARD_SAFE_NSIX509CERTDB(_to) \
  ...
  NS_IMETHOD SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetCertTrustFromString(cert, trustString); } \
  ...
  NS_IMETHOD ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ConstructX509FromBase64(base64, _retval); } \
  ...
  NS_IMETHOD AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddCert(certDER, aTrust, aName); } \
  ...
  NS_IMETHOD AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AsyncVerifyCertAtTime(aCert, aUsage, aFlags, aHostname, aTime, aCallback); } \
  NS_IMETHOD ClearOCSPCache(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearOCSPCache(); } \
  NS_IMETHOD AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddCertFromBase64(base64, aTrust, aName); } \
  NS_IMETHOD GetCerts(nsIX509CertList * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCerts(_retval); } \
  NS_IMETHOD GetEnterpriseRoots(nsIX509CertList * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnterpriseRoots(_retval); } 
...
/* void setCertTrustFromString (in nsIX509Cert cert, in ACString trustString); */
NS_IMETHODIMP nsX509CertDB::SetCertTrustFromString(nsIX509Cert *cert, const nsACString & trustString)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIX509Cert constructX509FromBase64 (in ACString base64); */
NS_IMETHODIMP nsX509CertDB::ConstructX509FromBase64(const nsACString & base64, nsIX509Cert * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void addCert (in ACString certDER, in ACString aTrust, in AUTF8String aName); */
NS_IMETHODIMP nsX509CertDB::AddCert(const nsACString & certDER, const nsACString & aTrust, const nsACString & aName)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void asyncVerifyCertAtTime (in nsIX509Cert aCert, in int64_t aUsage, in uint32_t aFlags, in string aHostname, in uint64_t aTime, in nsICertVerificationCallback aCallback); */
NS_IMETHODIMP nsX509CertDB::AsyncVerifyCertAtTime(nsIX509Cert *aCert, int64_t aUsage, uint32_t aFlags, const char * aHostname, uint64_t aTime, nsICertVerificationCallback *aCallback)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void addCertFromBase64 (in ACString base64, in ACString aTrust, in AUTF8String aName); */
NS_IMETHODIMP nsX509CertDB::AddCertFromBase64(const nsACString & base64, const nsACString & aTrust, const nsACString & aName)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIX509CertList getEnterpriseRoots (); */
NS_IMETHODIMP nsX509CertDB::GetEnterpriseRoots(nsIX509CertList * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
