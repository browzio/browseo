...
class NS_NO_VTABLE nsIPKCS11Slot : public nsISupports {
 public:
  ...
  NS_IMETHOD GetManID(nsACString & aManID) = 0;

  /* readonly attribute AUTF8String HWVersion; */
  NS_IMETHOD GetHWVersion(nsACString & aHWVersion) = 0;

  /* readonly attribute AUTF8String FWVersion; */
  NS_IMETHOD GetFWVersion(nsACString & aFWVersion) = 0;
...
#define NS_DECL_NSIPKCS11SLOT \
  ...
  NS_IMETHOD GetManID(nsACString & aManID) override; \
  NS_IMETHOD GetHWVersion(nsACString & aHWVersion) override; \
  NS_IMETHOD GetFWVersion(nsACString & aFWVersion) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIPKCS11SLOT \
  ...
  NS_METHOD GetDesc(nsACString & aDesc); \
  NS_METHOD GetManID(nsACString & aManID); \
  NS_METHOD GetHWVersion(nsACString & aHWVersion); \
  NS_METHOD GetFWVersion(nsACString & aFWVersion); \
...
#define NS_FORWARD_NSIPKCS11SLOT(_to) \
  ...
  NS_IMETHOD GetManID(nsACString & aManID) override { return _to GetManID(aManID); } \
  NS_IMETHOD GetHWVersion(nsACString & aHWVersion) override { return _to GetHWVersion(aHWVersion); } \
  NS_IMETHOD GetFWVersion(nsACString & aFWVersion) override { return _to GetFWVersion(aFWVersion); } \
...
#define NS_FORWARD_SAFE_NSIPKCS11SLOT(_to) \
  ...
  NS_IMETHOD GetManID(nsACString & aManID) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetManID(aManID); } \
  NS_IMETHOD GetHWVersion(nsACString & aHWVersion) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHWVersion(aHWVersion); } \
  NS_IMETHOD GetFWVersion(nsACString & aFWVersion) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFWVersion(aFWVersion); } \
...
/* readonly attribute AUTF8String name; */
NS_IMETHODIMP nsPKCS11Slot::GetName(nsACString & aName)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute AUTF8String desc; */
NS_IMETHODIMP nsPKCS11Slot::GetDesc(nsACString & aDesc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute AUTF8String manID; */
NS_IMETHODIMP nsPKCS11Slot::GetManID(nsACString & aManID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute AUTF8String HWVersion; */
NS_IMETHODIMP nsPKCS11Slot::GetHWVersion(nsACString & aHWVersion)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute AUTF8String FWVersion; */
NS_IMETHODIMP nsPKCS11Slot::GetFWVersion(nsACString & aFWVersion)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute AUTF8String tokenName; */
NS_IMETHODIMP nsPKCS11Slot::GetTokenName(nsACString & aTokenName)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
