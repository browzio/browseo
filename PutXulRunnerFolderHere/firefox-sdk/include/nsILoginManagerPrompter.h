...
class NS_NO_VTABLE nsILoginManagerPrompter : public nsISupports {
 public:
  ...
  NS_IMETHOD SetBrowser(nsIDOMElement *aBrowser) = 0;
...
#define NS_DECL_NSILOGINMANAGERPROMPTER \
  ...
  NS_IMETHOD SetBrowser(nsIDOMElement *aBrowser) override; \
  NS_IMETHOD GetOpener(nsIDOMWindow * *aOpener) override; \
  NS_IMETHOD SetOpener(nsIDOMWindow *aOpener) override; \
...
#define NS_DECL_NON_VIRTUAL_NSILOGINMANAGERPROMPTER \
  ...
  NS_METHOD SetBrowser(nsIDOMElement *aBrowser); \
  NS_METHOD GetOpener(nsIDOMWindow * *aOpener); \
  NS_METHOD SetOpener(nsIDOMWindow *aOpener); \
...
#define NS_FORWARD_NSILOGINMANAGERPROMPTER(_to) \
  ...
  NS_IMETHOD SetBrowser(nsIDOMElement *aBrowser) override { return _to SetBrowser(aBrowser); } \
  NS_IMETHOD GetOpener(nsIDOMWindow * *aOpener) override { return _to GetOpener(aOpener); } \
  NS_IMETHOD SetOpener(nsIDOMWindow *aOpener) override { return _to SetOpener(aOpener); } \
...
#define NS_FORWARD_SAFE_NSILOGINMANAGERPROMPTER(_to) \
  ...
  NS_IMETHOD SetBrowser(nsIDOMElement *aBrowser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBrowser(aBrowser); } \
  NS_IMETHOD GetOpener(nsIDOMWindow * *aOpener) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOpener(aOpener); } \
  NS_IMETHOD SetOpener(nsIDOMWindow *aOpener) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOpener(aOpener); } \
...
/* attribute nsIDOMElement browser; */
NS_IMETHODIMP nsLoginManagerPrompter::GetBrowser(nsIDOMElement * *aBrowser)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsLoginManagerPrompter::SetBrowser(nsIDOMElement *aBrowser)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute nsIDOMWindow opener; */
NS_IMETHODIMP nsLoginManagerPrompter::GetOpener(nsIDOMWindow * *aOpener)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsLoginManagerPrompter::SetOpener(nsIDOMWindow *aOpener)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
