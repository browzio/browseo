...
#define NS_IPRINCIPAL_IID_STR "3da7b133-f1a0-4de9-a2bc-5c49014c1077"

#define NS_IPRINCIPAL_IID \
  {0x3da7b133, 0xf1a0, 0x4de9, \
    { 0xa2, 0xbc, 0x5c, 0x49, 0x01, 0x4c, 0x10, 0x77 }}
...
#define NS_DECL_NON_VIRTUAL_NSIPRINCIPAL \
  ...
  using nsIPrincipal::GetPrivateBrowsingId; \
  NS_METHOD GetPrivateBrowsingId(uint32_t *aPrivateBrowsingId); \
  using nsIPrincipal::GetIsInIsolatedMozBrowserElement; \
...
/* readonly attribute AString addonId; */
NS_IMETHODIMP nsPrincipal::GetAddonId(nsAString & aAddonId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [infallible] readonly attribute unsigned long privateBrowsingId; */
NS_IMETHODIMP nsPrincipal::GetPrivateBrowsingId(uint32_t *aPrivateBrowsingId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
