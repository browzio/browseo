...
#ifndef mozilla_dom_VideoTrackBinding_h
#define mozilla_dom_VideoTrackBinding_h
...
namespace VideoTrackBinding {

  typedef mozilla::dom::VideoTrack NativeType;
...
#endif // mozilla_dom_VideoTrackBinding_h
