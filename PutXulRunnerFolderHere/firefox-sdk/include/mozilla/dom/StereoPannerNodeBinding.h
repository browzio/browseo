...
#ifndef mozilla_dom_StereoPannerNodeBinding_h
#define mozilla_dom_StereoPannerNodeBinding_h
...
namespace StereoPannerNodeBinding {

  typedef mozilla::dom::StereoPannerNode NativeType;
...
#endif // mozilla_dom_StereoPannerNodeBinding_h
