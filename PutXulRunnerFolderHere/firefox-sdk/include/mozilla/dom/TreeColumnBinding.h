...
#ifndef mozilla_dom_TreeColumnBinding_h
#define mozilla_dom_TreeColumnBinding_h
...
namespace TreeColumnBinding {

  typedef nsTreeColumn NativeType;
...
#endif // mozilla_dom_TreeColumnBinding_h
