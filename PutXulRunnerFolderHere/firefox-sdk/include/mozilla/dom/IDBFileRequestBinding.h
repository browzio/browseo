...
#ifndef mozilla_dom_IDBFileRequestBinding_h
#define mozilla_dom_IDBFileRequestBinding_h
...
namespace IDBFileRequestBinding {

  typedef mozilla::dom::IDBFileRequest NativeType;
...
#endif // mozilla_dom_IDBFileRequestBinding_h
