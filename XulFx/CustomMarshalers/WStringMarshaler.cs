...
namespace Gecko.CustomMarshalers
{
	...
	{
		public static readonly WStringMarshaler Instance = new WStringMarshaler(false);
		public static readonly WStringMarshaler InstanceShared = new WStringMarshaler(true);

		private readonly bool _shared;

		public WStringMarshaler(bool shared)
		{
			_shared = shared;
		}
		...
		static ICustomMarshaler GetInstance(string pstrCookie)
		{
			if (pstrCookie != null && pstrCookie.Contains("shared"))
				return WStringMarshaler.InstanceShared;
			return WStringMarshaler.Instance;
		}
	}
}
