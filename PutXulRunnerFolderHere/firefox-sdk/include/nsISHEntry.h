...
class NS_NO_VTABLE nsISHEntry : public nsISupports {
 public:
  ...
  /* [noscript] void create (in nsIURI URI, in AString title, in nsIInputStream inputStream, in nsILayoutHistoryState layoutHistoryState, in nsISupports cacheKey, in ACString contentType, in nsIPrincipal triggeringPrincipal, in nsIPrincipal principalToInherit, in unsigned long long docshellID, in boolean dynamicCreation); */
  NS_IMETHOD Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation) = 0;
...
#define NS_DECL_NSISHENTRY \
  ...
  NS_IMETHOD Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation) override; \
...
#define NS_DECL_NON_VIRTUAL_NSISHENTRY \
  ...
  NS_METHOD GetRefreshURIList(nsIMutableArray * *aRefreshURIList); \
  NS_METHOD SetRefreshURIList(nsIMutableArray *aRefreshURIList); \
  ...
  NS_METHOD Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation); \
...
#define NS_FORWARD_NSISHENTRY(_to) \
  ...
  NS_IMETHOD Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation) override { return _to Create(URI, title, inputStream, layoutHistoryState, cacheKey, contentType, triggeringPrincipal, principalToInherit, docshellID, dynamicCreation); } \
...
#define NS_FORWARD_SAFE_NSISHENTRY(_to) \
  ...
  NS_IMETHOD Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Create(URI, title, inputStream, layoutHistoryState, cacheKey, contentType, triggeringPrincipal, principalToInherit, docshellID, dynamicCreation); } \
...
/* attribute nsIMutableArray refreshURIList; */
NS_IMETHODIMP nsSHEntry::GetRefreshURIList(nsIMutableArray * *aRefreshURIList)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsSHEntry::SetRefreshURIList(nsIMutableArray *aRefreshURIList)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] void create (in nsIURI URI, in AString title, in nsIInputStream inputStream, in nsILayoutHistoryState layoutHistoryState, in nsISupports cacheKey, in ACString contentType, in nsIPrincipal triggeringPrincipal, in nsIPrincipal principalToInherit, in unsigned long long docshellID, in boolean dynamicCreation); */
NS_IMETHODIMP nsSHEntry::Create(nsIURI *URI, const nsAString & title, nsIInputStream *inputStream, nsILayoutHistoryState *layoutHistoryState, nsISupports *cacheKey, const nsACString & contentType, nsIPrincipal *triggeringPrincipal, nsIPrincipal *principalToInherit, uint64_t docshellID, bool dynamicCreation)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute nsIPrincipal triggeringPrincipal; */
NS_IMETHODIMP nsSHEntry::GetTriggeringPrincipal(nsIPrincipal * *aTriggeringPrincipal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsSHEntry::SetTriggeringPrincipal(nsIPrincipal *aTriggeringPrincipal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute nsIPrincipal principalToInherit; */
NS_IMETHODIMP nsSHEntry::GetPrincipalToInherit(nsIPrincipal * *aPrincipalToInherit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsSHEntry::SetPrincipalToInherit(nsIPrincipal *aPrincipalToInherit)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
