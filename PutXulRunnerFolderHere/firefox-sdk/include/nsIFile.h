...
#define NS_DECL_NON_VIRTUAL_NSIFILE \
  ...
  MOZ_MUST_USE NS_METHOD Create(uint32_t type, uint32_t permissions); \
  ...
  MOZ_MUST_USE NS_METHOD CreateUnique(uint32_t type, uint32_t permissions); \
  ...
  MOZ_MUST_USE NS_METHOD OpenNSPRFileDesc(int32_t flags, int32_t mode, PRFileDesc **_retval); \
  MOZ_MUST_USE NS_METHOD OpenANSIFileDesc(const char * mode, FILE **_retval); \
  MOZ_MUST_USE NS_METHOD Load(PRLibrary **_retval); \
  MOZ_MUST_USE NS_METHOD GetDiskSpaceAvailable(int64_t *aDiskSpaceAvailable); \
  ...
  MOZ_MUST_USE NS_METHOD GetPersistentDescriptor(nsACString & aPersistentDescriptor); \
  MOZ_MUST_USE NS_METHOD SetPersistentDescriptor(const nsACString & aPersistentDescriptor); \
  MOZ_MUST_USE NS_METHOD Reveal(void); \
  MOZ_MUST_USE NS_METHOD Launch(void); \
  MOZ_MUST_USE NS_METHOD GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval); \
  MOZ_MUST_USE NS_METHOD SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc); \
  MOZ_MUST_USE NS_METHOD GetRelativePath(nsIFile *fromFile, nsACString & _retval); \
  MOZ_MUST_USE NS_METHOD SetRelativePath(nsIFile *fromFile, const nsACString & relativeDesc); 
...
/* [must_use] void create (in unsigned long type, in unsigned long permissions); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::Create(uint32_t type, uint32_t permissions)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [must_use] void createUnique (in unsigned long type, in unsigned long permissions); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::CreateUnique(uint32_t type, uint32_t permissions)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [must_use,noscript] PRFileDescStar openNSPRFileDesc (in long flags, in long mode); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::OpenNSPRFileDesc(int32_t flags, int32_t mode, PRFileDesc **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use,noscript] FILE openANSIFileDesc (in string mode); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::OpenANSIFileDesc(const char * mode, FILE **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use,noscript] PRLibraryStar load (); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::Load(PRLibrary **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] readonly attribute int64_t diskSpaceAvailable; */
MOZ_MUST_USE NS_IMETHODIMP nsFile::GetDiskSpaceAvailable(int64_t *aDiskSpaceAvailable)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [must_use] attribute ACString persistentDescriptor; */
MOZ_MUST_USE NS_IMETHODIMP nsFile::GetPersistentDescriptor(nsACString & aPersistentDescriptor)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
MOZ_MUST_USE NS_IMETHODIMP nsFile::SetPersistentDescriptor(const nsACString & aPersistentDescriptor)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] void reveal (); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::Reveal()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] void launch (); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::Launch()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] ACString getRelativeDescriptor (in nsIFile fromFile); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] void setRelativeDescriptor (in nsIFile fromFile, in ACString relativeDesc); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] AUTF8String getRelativePath (in nsIFile fromFile); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::GetRelativePath(nsIFile *fromFile, nsACString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [must_use] void setRelativePath (in nsIFile fromFile, in AUTF8String relativeDesc); */
MOZ_MUST_USE NS_IMETHODIMP nsFile::SetRelativePath(nsIFile *fromFile, const nsACString & relativeDesc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
