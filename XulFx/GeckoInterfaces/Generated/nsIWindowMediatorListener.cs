...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIWindowMediatorListener.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIWindowMediatorListener
	{
		...
		void OnWindowTitleChange([MarshalAs(UnmanagedType.Interface)] nsIXULWindow window, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(WStringMarshaler))] string newTitle);
