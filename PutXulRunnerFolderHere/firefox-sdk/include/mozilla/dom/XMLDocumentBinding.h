...
#ifndef mozilla_dom_XMLDocumentBinding_h
#define mozilla_dom_XMLDocumentBinding_h
...
namespace XMLDocumentBinding {

  typedef mozilla::dom::XMLDocument NativeType;
...
#endif // mozilla_dom_XMLDocumentBinding_h
