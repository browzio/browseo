...
#ifndef mozilla_dom_MediaKeySessionBinding_h
#define mozilla_dom_MediaKeySessionBinding_h
...
namespace MediaKeySessionBinding {

  typedef mozilla::dom::MediaKeySession NativeType;
...
#endif // mozilla_dom_MediaKeySessionBinding_h
