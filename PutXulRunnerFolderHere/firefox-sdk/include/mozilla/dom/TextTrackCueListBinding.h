...
#ifndef mozilla_dom_TextTrackCueListBinding_h
#define mozilla_dom_TextTrackCueListBinding_h
...
namespace TextTrackCueListBinding {

  typedef mozilla::dom::TextTrackCueList NativeType;
...
#endif // mozilla_dom_TextTrackCueListBinding_h
