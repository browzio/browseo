...
class NS_NO_VTABLE nsICacheEntry : public nsISupports {
 public:
  ...
  NS_IMETHOD GetDiskStorageSizeInKB(uint32_t *aDiskStorageSizeInKB) = 0;
  ...
  NS_IMETHOD GetAltDataSize(int64_t *aAltDataSize) = 0;

  /* nsIOutputStream openAlternativeOutputStream (in ACString type); */
  NS_IMETHOD OpenAlternativeOutputStream(const nsACString & type, nsIOutputStream * *_retval) = 0;

  /* nsIInputStream openAlternativeInputStream (in ACString type); */
  NS_IMETHOD OpenAlternativeInputStream(const nsACString & type, nsIInputStream * *_retval) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSICACHEENTRY \
  ...
  NS_METHOD GetDiskStorageSizeInKB(uint32_t *aDiskStorageSizeInKB); \
  NS_METHOD Recreate(bool aMemoryOnly, nsICacheEntry * *_retval); \
  NS_METHOD GetDataSize(int64_t *aDataSize); \
  NS_METHOD GetAltDataSize(int64_t *aAltDataSize); \
  NS_METHOD OpenAlternativeOutputStream(const nsACString & type, nsIOutputStream * *_retval); \
  NS_METHOD OpenAlternativeInputStream(const nsACString & type, nsIInputStream * *_retval); \
...
#define NS_FORWARD_NSICACHEENTRY(_to) \
  ...
  NS_IMETHOD OpenAlternativeOutputStream(const nsACString & type, nsIOutputStream * *_retval) override { return _to OpenAlternativeOutputStream(type, _retval); } \
...
#define NS_FORWARD_SAFE_NSICACHEENTRY(_to) \
  ...
  NS_IMETHOD OpenAlternativeOutputStream(const nsACString & type, nsIOutputStream * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenAlternativeOutputStream(type, _retval); } \
...
/* readonly attribute uint32_t diskStorageSizeInKB; */
NS_IMETHODIMP nsCacheEntry::GetDiskStorageSizeInKB(uint32_t *aDiskStorageSizeInKB)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute long long altDataSize; */
NS_IMETHODIMP nsCacheEntry::GetAltDataSize(int64_t *aAltDataSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIOutputStream openAlternativeOutputStream (in ACString type); */
NS_IMETHODIMP nsCacheEntry::OpenAlternativeOutputStream(const nsACString & type, nsIOutputStream * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIInputStream openAlternativeInputStream (in ACString type); */
NS_IMETHODIMP nsCacheEntry::OpenAlternativeInputStream(const nsACString & type, nsIInputStream * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
