...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIWindowsShellService.idl
// 
...
namespace Gecko.Interfaces
{
	...
	[ComImport]
	[Guid("f8a26b94-49e5-4441-8fbc-315e0b4f22ef")]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	public interface nsIWindowsShellService : nsIShellService
	{
		
		#region nsIShellService Members
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void SetDesktopBackgroundColorAttribute(uint value);
		...
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		new void OpenApplicationWithURI([MarshalAs(UnmanagedType.Interface)] nsIFile aApplication, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(ACStringMarshaler))] nsACStringBase aURI);
