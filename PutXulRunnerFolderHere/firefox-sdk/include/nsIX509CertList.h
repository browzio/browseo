...
class NS_NO_VTABLE nsIX509CertList : public nsISupports {
 public:
  ...
  NS_IMETHOD_(CERTCertList *) GetRawCertList(void) = 0;
...
#define NS_DECL_NSIX509CERTLIST \
  ...
  NS_IMETHOD_(CERTCertList *) GetRawCertList(void) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIX509CERTLIST \
  ...
  NS_METHOD_(CERTCertList *) GetRawCertList(void); \
...
#define NS_FORWARD_NSIX509CERTLIST(_to) \
  ...
  NS_IMETHOD_(CERTCertList *) GetRawCertList(void) override { return _to GetRawCertList(); } \
...
/* [noscript,notxpcom] CERTCertListPtr getRawCertList (); */
NS_IMETHODIMP_(CERTCertList *) nsX509CertList::GetRawCertList()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
