...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file inIDOMView.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface inIDOMView
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetRootNodeAttribute([MarshalAs(UnmanagedType.Interface)] nsIDOMNode value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetShowAnonymousContentAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetShowSubDocumentsAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetShowWhitespaceNodesAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetShowAccessibleNodesAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		uint GetWhatToShowAttribute();
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetWhatToShowAttribute(uint value);
