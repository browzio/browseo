...
class NS_NO_VTABLE nsIUnicharStreamLoader : public nsIStreamListener {
 public:
  ...
  NS_IMETHOD GetRawBuffer(nsACString & aRawBuffer) = 0;
...
#define NS_DECL_NSIUNICHARSTREAMLOADER \
  ...
  NS_IMETHOD GetRawBuffer(nsACString & aRawBuffer) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIUNICHARSTREAMLOADER \
  ...
  NS_METHOD GetRawBuffer(nsACString & aRawBuffer); 
...
#define NS_FORWARD_NSIUNICHARSTREAMLOADER(_to) \
  ...
  NS_IMETHOD GetRawBuffer(nsACString & aRawBuffer) override { return _to GetRawBuffer(aRawBuffer); } 
...
#define NS_FORWARD_SAFE_NSIUNICHARSTREAMLOADER(_to) \
  ...
  NS_IMETHOD GetRawBuffer(nsACString & aRawBuffer) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRawBuffer(aRawBuffer); } 
...
/* readonly attribute ACString rawBuffer; */
NS_IMETHODIMP nsUnicharStreamLoader::GetRawBuffer(nsACString & aRawBuffer)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
