...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIStringStream.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIStringInputStream : nsIInputStream
	{
		...
		/// </param>
		/// <param name="dataLen">
		/// - stream data length (-1 if length should be computed)
		/// 
		...
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetData([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(StringMarshaler))] string data, int dataLen);
		...
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void ShareData([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(StringMarshaler))] string data, int dataLen);
