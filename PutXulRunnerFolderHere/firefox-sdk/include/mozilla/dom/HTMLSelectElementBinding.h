...
#ifndef mozilla_dom_HTMLSelectElementBinding_h
#define mozilla_dom_HTMLSelectElementBinding_h
...
namespace HTMLSelectElementBinding {

  typedef mozilla::dom::HTMLSelectElement NativeType;
...
#endif // mozilla_dom_HTMLSelectElementBinding_h
