...
class NS_NO_VTABLE nsILoginManager : public nsISupports {
 public:
  ...
  NS_IMETHOD AddLogin(nsILoginInfo *aLogin, nsILoginInfo * *_retval) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSILOGINMANAGER \
  ...
  NS_METHOD AddLogin(nsILoginInfo *aLogin, nsILoginInfo * *_retval); \
...
/* nsILoginInfo addLogin (in nsILoginInfo aLogin); */
NS_IMETHODIMP nsLoginManager::AddLogin(nsILoginInfo *aLogin, nsILoginInfo * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void stopSearch (); */
NS_IMETHODIMP nsLoginManager::StopSearch()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
