...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsITreeBoxObject.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsITreeBoxObject
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetFocusedAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		/// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetCellAt(int x, int y, out int row, [MarshalAs(UnmanagedType.Interface)] out nsITreeColumn col, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase childElt);
		
		/// <summary>
		/// Find the coordinates of an element within a specific cell.
		/// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetCoordsForCellItem(int row, [MarshalAs(UnmanagedType.Interface)] nsITreeColumn col, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase element, out int x, out int y, out int width, out int height);
