...
class nsIArrayExtensions; /* forward declaration */
...
class NS_NO_VTABLE inIDOMUtils : public nsISupports {
 public:
  ...
  NS_IMETHOD GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval) = 0;
...
#define NS_DECL_INIDOMUTILS \
  ...
  NS_IMETHOD GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_INIDOMUTILS \
  ...
  NS_METHOD GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval); \
...
#define NS_FORWARD_INIDOMUTILS(_to) \
  ...
  NS_IMETHOD GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval) override { return _to GetCSSStyleRules(aElement, aPseudo, _retval); } \
...
#define NS_FORWARD_SAFE_INIDOMUTILS(_to) \
  ...
  NS_IMETHOD GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCSSStyleRules(aElement, aPseudo, _retval); } \
...
/* nsIArrayExtensions getCSSStyleRules (in nsIDOMElement aElement, [optional] in DOMString aPseudo); */
NS_IMETHODIMP inDOMUtils::GetCSSStyleRules(nsIDOMElement *aElement, const nsAString & aPseudo, nsIArrayExtensions * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
