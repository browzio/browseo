...
#ifndef mozilla_dom_NamedNodeMapBinding_h
#define mozilla_dom_NamedNodeMapBinding_h
...
namespace NamedNodeMapBinding {

  typedef nsDOMAttributeMap NativeType;
...
#endif // mozilla_dom_NamedNodeMapBinding_h
