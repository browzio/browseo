...
struct WifiCertServiceResultOptions : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR nsString mNickname;
  MOZ_INIT_OUTSIDE_CTOR int32_t mStatus;
  MOZ_INIT_OUTSIDE_CTOR uint16_t mUsageFlag;
...
struct WifiCommandOptions : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR int32_t mId;
  MOZ_INIT_OUTSIDE_CTOR Optional<nsString> mRequest;
