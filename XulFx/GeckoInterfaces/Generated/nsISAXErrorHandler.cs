...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsISAXErrorHandler.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsISAXErrorHandler
	{
		...
		/// </summary>
		/// <param name="locator">
		/// The locator object for the error (may be null).
		/// </param>
		/// <param name="error">
		/// The error message.
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void Error([MarshalAs(UnmanagedType.Interface)] nsISAXLocator locator, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase error);
		...
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void FatalError([MarshalAs(UnmanagedType.Interface)] nsISAXLocator locator, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase error);
		...
		/// </summary>
		/// <param name="locator">
		/// The locator object for the warning (may be null).
		/// </param>
		/// <param name="error">
		/// The warning message.
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void IgnorableWarning([MarshalAs(UnmanagedType.Interface)] nsISAXLocator locator, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase error);
	}
}
