...
class NS_NO_VTABLE MOZ_DEPRECATED nsICollection : public nsISerializable {
 public:
  ...
  /* [binaryname(DeprecatedEnumerate)] nsIEnumerator Enumerate (); */
  NS_IMETHOD DeprecatedEnumerate(nsIEnumerator * *_retval) = 0;
...
#define NS_DECL_NSICOLLECTION \
  ...
  NS_IMETHOD DeprecatedEnumerate(nsIEnumerator * *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSICOLLECTION \
  ...
  NS_METHOD DeprecatedEnumerate(nsIEnumerator * *_retval); \
...
#define NS_FORWARD_NSICOLLECTION(_to) \
  ...
  NS_IMETHOD DeprecatedEnumerate(nsIEnumerator * *_retval) override { return _to DeprecatedEnumerate(_retval); } \
...
#define NS_FORWARD_SAFE_NSICOLLECTION(_to) \
  ...
  NS_IMETHOD DeprecatedEnumerate(nsIEnumerator * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DeprecatedEnumerate(_retval); } \
...
/* [binaryname(DeprecatedEnumerate)] nsIEnumerator Enumerate (); */
NS_IMETHODIMP nsCollection::DeprecatedEnumerate(nsIEnumerator * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
