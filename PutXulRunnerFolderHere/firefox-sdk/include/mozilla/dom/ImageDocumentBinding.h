...
#ifndef mozilla_dom_ImageDocumentBinding_h
#define mozilla_dom_ImageDocumentBinding_h
...
namespace ImageDocumentBinding {

  typedef mozilla::dom::ImageDocument NativeType;
...
#endif // mozilla_dom_ImageDocumentBinding_h
