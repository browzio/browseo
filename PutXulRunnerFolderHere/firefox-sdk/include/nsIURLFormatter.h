...
class NS_NO_VTABLE nsIURLFormatter : public nsISupports {
 public:
  ...
  NS_IMETHOD TrimSensitiveURLs(const nsAString & aMsg, nsAString & _retval) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIURLFORMATTER \
  ...
  NS_METHOD TrimSensitiveURLs(const nsAString & aMsg, nsAString & _retval); 
...
/* AString trimSensitiveURLs (in AString aMsg); */
NS_IMETHODIMP nsURLFormatter::TrimSensitiveURLs(const nsAString & aMsg, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
