...
class nsIXMLHttpRequest : public nsISupports {
 public:
  ...
  NS_IMETHOD Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup) = 0;
...
#define NS_DECL_NSIXMLHTTPREQUEST \
  ...
  NS_IMETHOD Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIXMLHTTPREQUEST \
  ...
  NS_METHOD Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup); \
...
#define NS_FORWARD_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_IMETHOD Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup) override { return _to Init(principal, globalObject, baseURI, loadGroup); } \
...
#define NS_FORWARD_SAFE_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_IMETHOD Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(principal, globalObject, baseURI, loadGroup); } \
...
/* [noscript] void init (in nsIPrincipal principal, in nsIGlobalObject globalObject, in nsIURI baseURI, [optional] in nsILoadGroup loadGroup); */
NS_IMETHODIMP nsXMLHttpRequest::Init(nsIPrincipal *principal, nsIGlobalObject *globalObject, nsIURI *baseURI, nsILoadGroup *loadGroup)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
