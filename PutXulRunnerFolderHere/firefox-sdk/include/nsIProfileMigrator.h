...
class NS_NO_VTABLE nsIProfileMigrator : public nsISupports {
 public:
  ...
  NS_IMETHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey, const nsACString & aProfileName) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIPROFILEMIGRATOR \
  NS_METHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey, const nsACString & aProfileName); 
...
/* void migrate (in nsIProfileStartup aStartup, in ACString aKey, [optional] in ACString aProfileName); */
NS_IMETHODIMP nsProfileMigrator::Migrate(nsIProfileStartup *aStartup, const nsACString & aKey, const nsACString & aProfileName)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
