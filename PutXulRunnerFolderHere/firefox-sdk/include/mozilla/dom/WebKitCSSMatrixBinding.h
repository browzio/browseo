...
#ifndef mozilla_dom_WebKitCSSMatrixBinding_h
#define mozilla_dom_WebKitCSSMatrixBinding_h
...
namespace WebKitCSSMatrixBinding {

  typedef mozilla::dom::WebKitCSSMatrix NativeType;
...
#endif // mozilla_dom_WebKitCSSMatrixBinding_h
