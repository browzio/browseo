...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIExternalProtocolHandler.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIExternalProtocolHandler : nsIProtocolHandler
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		[return: System.Runtime.InteropServices.MarshalAs(UnmanagedType.U1)]
		bool ExternalAppExistsForScheme([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(ACStringMarshaler))] nsACStringBase scheme);
	}
}
