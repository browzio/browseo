...
#ifndef mozilla_dom_ShadowRootBinding_h
#define mozilla_dom_ShadowRootBinding_h
...
namespace ShadowRootBinding {

  typedef mozilla::dom::ShadowRoot NativeType;
...
#endif // mozilla_dom_ShadowRootBinding_h
