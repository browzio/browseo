...
bool
ToJSValue(JSContext* aCx, RequestContext aArgument, JS::MutableHandle<JS::Value> aValue);
...
enum class RequestRedirect : uint32_t {
  Follow,
  Error,
  Manual,
  EndGuard_
...
enum class ReferrerPolicy : uint32_t {
  _empty,
  No_referrer,
...
{
  MOZ_INIT_OUTSIDE_CTOR Optional<Nullable<OwningArrayBufferOrArrayBufferViewOrBlobOrFormDataOrUSVStringOrURLSearchParams >> mBody;
  MOZ_INIT_OUTSIDE_CTOR Optional<RequestCache> mCache;
  MOZ_INIT_OUTSIDE_CTOR Optional<RequestCredentials> mCredentials;
  MOZ_INIT_OUTSIDE_CTOR Optional<OwningHeadersOrByteStringSequenceSequenceOrByteStringMozMap> mHeaders;
