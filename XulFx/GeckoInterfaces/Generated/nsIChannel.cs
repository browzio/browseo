...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIChannel.idl
// 
...
namespace Gecko.Interfaces
{
	...
	// <summary>
	// Constants for nsIChannel ( "2c389865-23db-4aa7-9fe5-60cc7b00697e" ) interface
	// </summary>
	public sealed class nsIChannelConsts
	{
		
		public const uint LOAD_DOCUMENT_URI = (1 << 16);
		
		public const uint LOAD_RETARGETED_DOCUMENT_URI = (1 << 17);
		
		public const uint LOAD_REPLACE = (1 << 18);
		
		public const uint LOAD_INITIAL_DOCUMENT_URI = (1 << 19);
		
		public const uint LOAD_TARGETED = (1 << 20);
		
		public const uint LOAD_CALL_CONTENT_SNIFFERS = (1 << 21);
		
		public const uint LOAD_CLASSIFY_URI = (1 << 22);
		
		public const uint LOAD_MEDIA_SNIFFER_OVERRIDES_CONTENT_TYPE = (1 << 23);
		
		public const uint LOAD_EXPLICIT_CREDENTIALS = (1 << 24);
		
		public const uint LOAD_BYPASS_SERVICE_WORKER = (1 << 25);
		
		public const uint DISPOSITION_INLINE = 0;
		
		public const uint DISPOSITION_ATTACHMENT = 1;
	}
	...
	public interface nsIChannel : nsIRequest
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetOwnerAttribute([MarshalAs(UnmanagedType.Interface)] nsISupports value);
		...
		/// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetContentCharsetAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(ACStringMarshaler))] nsACStringBase result);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetContentCharsetAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(ACStringMarshaler))] nsACStringBase value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetContentLengthAttribute(long value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetContentDispositionAttribute(uint value);
		...
		/// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetContentDispositionFilenameAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase result);
		
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetContentDispositionFilenameAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase value);
		...
		/// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void GetContentDispositionHeaderAttribute([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(ACStringMarshaler))] nsACStringBase result);
