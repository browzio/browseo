...
{
  MOZ_INIT_OUTSIDE_CTOR Optional<nsString> mSettingName;
  MOZ_INIT_OUTSIDE_CTOR Optional<nsString> mSettingValue;
...
{
public:
  explicit inline SettingChangeCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackFunction(aCx, aCallback, aIncumbentGlobal)
  {
    MOZ_ASSERT(JS::IsCallable(mCallback));
  }

  explicit inline SettingChangeCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackFunction(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
    MOZ_ASSERT(JS::IsCallable(mCallback));
  }

  explicit inline SettingChangeCallback(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
  ...
  template <typename T>
  inline void
  Call(const T& thisVal, const SettingChange& setting, const char* aExecutionReason = nullptr)
  {
    IgnoredErrorResult rv;
    return Call(thisVal, setting, rv, aExecutionReason);
  }

  inline void
  Call(const SettingChange& setting, const char* aExecutionReason = nullptr)
  {
    IgnoredErrorResult rv;
    return Call(setting, rv, aExecutionReason, eReportExceptions, nullptr);
  }
...
namespace binding_detail {
class FastSettingChangeCallback : public SettingChangeCallback
{
public:
  explicit inline FastSettingChangeCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : SettingChangeCallback(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }
  ...
  {
    SettingChangeCallback::Trace(aTracer);
  }

  inline void
  HoldJSObjectsIfMoreThanOneOwner()
  {
    SettingChangeCallback::HoldJSObjectsIfMoreThanOneOwner();
  }
};
} // namespace binding_detail
...
namespace SettingsManagerBinding {
  ...
  already_AddRefed<SettingsManager>
...
{
public:
  explicit inline SettingsLockJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal)
  {
  }

  explicit inline SettingsLockJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }

  explicit inline SettingsLockJSImpl(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
...
private:
  RefPtr<SettingsLockJSImpl> mImpl;
...
{
public:
  explicit inline SettingsManagerJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal)
  {
  }

  explicit inline SettingsManagerJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }

  explicit inline SettingsManagerJSImpl(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
    : CallbackInterface(aCallback, aAsyncStack, aIncumbentGlobal)
  {
  }
...
private:
  RefPtr<SettingsManagerJSImpl> mImpl;
  nsCOMPtr<nsISupports> mParent;
