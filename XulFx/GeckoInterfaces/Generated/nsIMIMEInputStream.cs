...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIMIMEInputStream.idl
// 
...
namespace Gecko.Interfaces
{
	...
	public interface nsIMIMEInputStream : nsIInputStream
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetAddContentLengthAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		/// </param>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void AddHeader([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(StringMarshaler))] string name, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(StringMarshaler))] string value);
