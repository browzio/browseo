...
struct WifiTetheringConfig : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR Optional<SecurityType> mSecurity;
...
struct TetheringConfiguration : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR WifiTetheringConfig mWifiConfig;
...
namespace MozTetheringManagerBinding {
  ...
  already_AddRefed<MozTetheringManager>
...
public:
  ...
  explicit inline MozTetheringManagerJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }

  explicit inline MozTetheringManagerJSImpl(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
