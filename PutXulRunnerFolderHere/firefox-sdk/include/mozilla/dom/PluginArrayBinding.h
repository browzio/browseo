...
#ifndef mozilla_dom_PluginArrayBinding_h
#define mozilla_dom_PluginArrayBinding_h
...
namespace PluginArrayBinding {

  typedef nsPluginArray NativeType;
...
#endif // mozilla_dom_PluginArrayBinding_h
