...
{
public:
  explicit inline NotificationPermissionCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackFunction(aCx, aCallback, aIncumbentGlobal)
  {
    MOZ_ASSERT(JS::IsCallable(mCallback));
  }

  explicit inline NotificationPermissionCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackFunction(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
    MOZ_ASSERT(JS::IsCallable(mCallback));
  }

  explicit inline NotificationPermissionCallback(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
  ...
  Call(const T& thisVal, NotificationPermission permission, const char* aExecutionReason = nullptr)
  {
    ...
    return Call(thisVal, permission, rv, aExecutionReason);
  }
  ...
  {
    IgnoredErrorResult rv;
    return Call(permission, rv, aExecutionReason, eReportExceptions, nullptr);
  }
...
{
public:
  explicit inline FastNotificationPermissionCallback(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : NotificationPermissionCallback(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }
  ...
  {
    NotificationPermissionCallback::HoldJSObjectsIfMoreThanOneOwner();
  }
};
} // namespace binding_detail
