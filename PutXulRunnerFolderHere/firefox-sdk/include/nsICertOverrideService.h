...
class NS_NO_VTABLE nsICertOverrideService : public nsISupports {
 public:
  ...
  NS_IMETHOD RememberTemporaryValidityOverrideUsingFingerprint(const nsACString & aHostName, int32_t aPort, const nsACString & aCertFingerprint, uint32_t aOverrideBits) = 0;
...
#define NS_DECL_NSICERTOVERRIDESERVICE \
  ...
  NS_IMETHOD RememberTemporaryValidityOverrideUsingFingerprint(const nsACString & aHostName, int32_t aPort, const nsACString & aCertFingerprint, uint32_t aOverrideBits) override; \
...
#define NS_DECL_NON_VIRTUAL_NSICERTOVERRIDESERVICE \
  ...
  NS_METHOD RememberTemporaryValidityOverrideUsingFingerprint(const nsACString & aHostName, int32_t aPort, const nsACString & aCertFingerprint, uint32_t aOverrideBits); \
...
#define NS_FORWARD_NSICERTOVERRIDESERVICE(_to) \
  ...
  NS_IMETHOD RememberTemporaryValidityOverrideUsingFingerprint(const nsACString & aHostName, int32_t aPort, const nsACString & aCertFingerprint, uint32_t aOverrideBits) override { return _to RememberTemporaryValidityOverrideUsingFingerprint(aHostName, aPort, aCertFingerprint, aOverrideBits); } \
...
/* void rememberTemporaryValidityOverrideUsingFingerprint (in ACString aHostName, in int32_t aPort, in ACString aCertFingerprint, in uint32_t aOverrideBits); */
NS_IMETHODIMP nsCertOverrideService::RememberTemporaryValidityOverrideUsingFingerprint(const nsACString & aHostName, int32_t aPort, const nsACString & aCertFingerprint, uint32_t aOverrideBits)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
