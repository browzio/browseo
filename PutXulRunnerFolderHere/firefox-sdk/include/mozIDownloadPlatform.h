...
class NS_NO_VTABLE mozIDownloadPlatform : public nsISupports {
 public:
  ...
  NS_IMETHOD DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate) = 0;
...
#define NS_DECL_MOZIDOWNLOADPLATFORM \
  NS_IMETHOD DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate) override; \
...
#define NS_DECL_NON_VIRTUAL_MOZIDOWNLOADPLATFORM \
  NS_METHOD DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate); \
...
#define NS_FORWARD_MOZIDOWNLOADPLATFORM(_to) \
  NS_IMETHOD DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate) override { return _to DownloadDone(aSource, aReferrer, aTarget, aContentType, aIsPrivate); } \
...
#define NS_FORWARD_SAFE_MOZIDOWNLOADPLATFORM(_to) \
  NS_IMETHOD DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate) override { return !_to ? NS_ERROR_NULL_POINTER : _to->DownloadDone(aSource, aReferrer, aTarget, aContentType, aIsPrivate); } \
...
/* void downloadDone (in nsIURI aSource, in nsIURI aReferrer, in nsIFile aTarget, in ACString aContentType, in boolean aIsPrivate); */
NS_IMETHODIMP _MYCLASS_::DownloadDone(nsIURI *aSource, nsIURI *aReferrer, nsIFile *aTarget, const nsACString & aContentType, bool aIsPrivate)
{
