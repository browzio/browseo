...
#ifndef mozilla_dom_XULDocumentBinding_h
#define mozilla_dom_XULDocumentBinding_h
...
namespace XULDocumentBinding {

  typedef mozilla::dom::XULDocument NativeType;
...
#endif // mozilla_dom_XULDocumentBinding_h
