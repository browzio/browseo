...
#ifndef mozilla_dom_RecordErrorEventBinding_h
#define mozilla_dom_RecordErrorEventBinding_h
...
struct RecordErrorEventInit : public EventInit
{
  ...
  explicit inline RecordErrorEventInit(const FastDictionaryInitializer& )
...
struct FastRecordErrorEventInit : public RecordErrorEventInit
{
  inline FastRecordErrorEventInit()
    : RecordErrorEventInit(FastDictionaryInitializer())
  {
...
namespace RecordErrorEventBinding {
  ...
  bool
  Wrap(JSContext* aCx, mozilla::dom::RecordErrorEvent* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector);
...
#endif // mozilla_dom_RecordErrorEventBinding_h
