...
class NS_NO_VTABLE nsIDOMHTMLMediaElement : public nsISupports {
 public:
  ...
  NS_IMETHOD_(void) OnVisibilityChange(mozilla::Visibility aNewVisibility) = 0;
...
#define NS_DECL_NSIDOMHTMLMEDIAELEMENT \
  ...
  NS_IMETHOD_(void) OnVisibilityChange(mozilla::Visibility aNewVisibility) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLMEDIAELEMENT \
  ...
  NS_METHOD_(void) OnVisibilityChange(mozilla::Visibility aNewVisibility); 
...
#define NS_FORWARD_NSIDOMHTMLMEDIAELEMENT(_to) \
  ...
  NS_IMETHOD_(void) OnVisibilityChange(mozilla::Visibility aNewVisibility) override { return _to OnVisibilityChange(aNewVisibility); } 
...
/* [noscript,notxpcom] void onVisibilityChange (in Visibility aNewVisibility); */
NS_IMETHODIMP_(void) nsDOMHTMLMediaElement::OnVisibilityChange(mozilla::Visibility aNewVisibility)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
