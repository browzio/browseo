...
class NS_NO_VTABLE nsIAutoCompleteController : public nsISupports {
 public:
  ...
  /* boolean handleText (); */
  NS_IMETHOD HandleText(bool *_retval) = 0;

  /* boolean handleEnter (in boolean aIsPopupSelection, [optional] in nsIDOMEvent aEvent); */
  NS_IMETHOD HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval) = 0;
  ...
  NS_IMETHOD SetInitiallySelectedIndex(int32_t index) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETECONTROLLER \
  ...
  NS_IMETHOD HandleText(bool *_retval) override; \
  NS_IMETHOD HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIAUTOCOMPLETECONTROLLER \
  ...
  NS_METHOD HandleText(bool *_retval); \
  NS_METHOD HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval); \
  ...
  NS_METHOD SetInitiallySelectedIndex(int32_t index); 
...
#define NS_FORWARD_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_IMETHOD HandleText(bool *_retval) override { return _to HandleText(_retval); } \
  NS_IMETHOD HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval) override { return _to HandleEnter(aIsPopupSelection, aEvent, _retval); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_IMETHOD HandleText(bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleText(_retval); } \
  NS_IMETHOD HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleEnter(aIsPopupSelection, aEvent, _retval); } \
...
/* boolean handleText (); */
NS_IMETHODIMP nsAutoCompleteController::HandleText(bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean handleEnter (in boolean aIsPopupSelection, [optional] in nsIDOMEvent aEvent); */
NS_IMETHODIMP nsAutoCompleteController::HandleEnter(bool aIsPopupSelection, nsIDOMEvent *aEvent, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void setInitiallySelectedIndex (in long index); */
NS_IMETHODIMP nsAutoCompleteController::SetInitiallySelectedIndex(int32_t index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
