...
#define NS_DECL_NON_VIRTUAL_NSIBASEWINDOW \
  ...
  NS_METHOD SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, uint32_t flags); \
...
/* void setPositionAndSize (in long x, in long y, in long cx, in long cy, in unsigned long flags); */
NS_IMETHODIMP nsBaseWindow::SetPositionAndSize(int32_t x, int32_t y, int32_t cx, int32_t cy, uint32_t flags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
