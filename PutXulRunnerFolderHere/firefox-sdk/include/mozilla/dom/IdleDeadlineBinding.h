...
#ifndef mozilla_dom_IdleDeadlineBinding_h
#define mozilla_dom_IdleDeadlineBinding_h
...
namespace IdleDeadlineBinding {

  typedef mozilla::dom::IdleDeadline NativeType;
...
#endif // mozilla_dom_IdleDeadlineBinding_h
