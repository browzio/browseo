...
#ifndef mozilla_dom_TextClauseBinding_h
#define mozilla_dom_TextClauseBinding_h
...
namespace TextClauseBinding {

  typedef mozilla::dom::TextClause NativeType;
...
#endif // mozilla_dom_TextClauseBinding_h
