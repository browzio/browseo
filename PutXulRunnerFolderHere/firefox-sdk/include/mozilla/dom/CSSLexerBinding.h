...
struct CSSToken : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR Optional<bool> mHasSign;
  MOZ_INIT_OUTSIDE_CTOR Optional<bool> mIsInteger;
  MOZ_INIT_OUTSIDE_CTOR Optional<double> mNumber;
  MOZ_INIT_OUTSIDE_CTOR uint32_t mStartOffset;
  MOZ_INIT_OUTSIDE_CTOR Optional<nsString> mText;
  MOZ_INIT_OUTSIDE_CTOR CSSTokenType mTokenType;
