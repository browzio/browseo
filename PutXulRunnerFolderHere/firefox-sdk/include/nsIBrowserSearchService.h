...
class NS_NO_VTABLE nsIBrowserSearchService : public nsISupports {
 public:
  ...
  NS_IMETHOD HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval) = 0;
...
#define NS_DECL_NSIBROWSERSEARCHSERVICE \
  ...
  NS_IMETHOD HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIBROWSERSEARCHSERVICE \
  ...
  NS_METHOD HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval); \
  ...
  NS_METHOD GetOriginalDefaultEngine(nsISearchEngine * *aOriginalDefaultEngine); \
...
#define NS_FORWARD_NSIBROWSERSEARCHSERVICE(_to) \
  ...
  NS_IMETHOD HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval) override { return _to HasEngineWithURL(method, url, formData, _retval); } \
...
#define NS_FORWARD_SAFE_NSIBROWSERSEARCHSERVICE(_to) \
  ...
  NS_IMETHOD HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HasEngineWithURL(method, url, formData, _retval); } \
...
/* boolean hasEngineWithURL (in AString method, in AString url, in jsval formData); */
NS_IMETHODIMP nsBrowserSearchService::HasEngineWithURL(const nsAString & method, const nsAString & url, JS::HandleValue formData, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
