...
#define NS_DECL_NON_VIRTUAL_NSIRUNNABLEPRIORITY \
  NS_METHOD GetPriority(uint32_t *aPriority); 
...
/* Header file */
class nsRunnablePriority : public nsIRunnablePriority
{
public:
  NS_DECL_ISUPPORTS
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsRunnablePriority, nsIRunnablePriority)

nsRunnablePriority::nsRunnablePriority()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute unsigned long priority; */
NS_IMETHODIMP nsRunnablePriority::GetPriority(uint32_t *aPriority)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
