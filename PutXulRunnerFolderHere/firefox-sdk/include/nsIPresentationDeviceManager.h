/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM ../../../dist/idl\nsIPresentationDeviceManager.idl
 */
...
class NS_NO_VTABLE nsIPresentationDeviceManager : public nsISupports {
 public:
  ...
  NS_IMETHOD GetAvailableDevices(nsIArray *presentationUrls, nsIArray * *_retval) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSIPRESENTATIONDEVICEMANAGER \
  ...
  NS_METHOD GetAvailableDevices(nsIArray *presentationUrls, nsIArray * *_retval); 
...
/* nsIArray getAvailableDevices ([optional] in nsIArray presentationUrls); */
NS_IMETHODIMP nsPresentationDeviceManager::GetAvailableDevices(nsIArray *presentationUrls, nsIArray * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
