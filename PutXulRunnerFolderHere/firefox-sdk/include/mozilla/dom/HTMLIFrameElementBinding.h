...
#ifndef mozilla_dom_HTMLIFrameElementBinding_h
#define mozilla_dom_HTMLIFrameElementBinding_h
...
namespace HTMLIFrameElementBinding {
  ...
  typedef mozilla::dom::HTMLIFrameElement NativeType;
...
#endif // mozilla_dom_HTMLIFrameElementBinding_h
