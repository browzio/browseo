...
// License.
// --------------------------------------------------------------------------------------------
// Generated by XPIDLImporter from file nsIDOMEvent.idl
// 
...
namespace Gecko.Interfaces
{
	...
	// <summary>
	// Constants for nsIDOMEvent ( "f58daacf-4d1a-4002-8fd7-06b614dfbcf6" ) interface
	// </summary>
	public sealed class nsIDOMEventConsts
	{
	...
	public interface nsIDOMEvent
	{
		...
		/// Specifies the event type. This type may be
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void InitEvent([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef=typeof(AStringMarshaler))] nsAStringBase eventTypeArg, [MarshalAs(UnmanagedType.U1)] bool canBubbleArg, [MarshalAs(UnmanagedType.U1)] bool cancelableArg);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetCancelBubbleAttribute([MarshalAs(UnmanagedType.U1)] bool value);
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		[return: System.Runtime.InteropServices.MarshalAs(UnmanagedType.U1)]
		bool Deserialize(System.IntPtr aMsg, System.IntPtr aIter);
		
		[PreserveSig]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetOwner(System.IntPtr aOwner);
