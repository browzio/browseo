...
class NS_NO_VTABLE nsITaggingService : public nsISupports {
 public:
  ...
  NS_IMETHOD TagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource) = 0;

  /* void untagURI (in nsIURI aURI, in nsIVariant aTags, [optional] in unsigned short aSource); */
  NS_IMETHOD UntagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource) = 0;
...
#define NS_DECL_NON_VIRTUAL_NSITAGGINGSERVICE \
  NS_METHOD TagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource); \
  NS_METHOD UntagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource); \
...
/* void tagURI (in nsIURI aURI, in nsIVariant aTags, [optional] in unsigned short aSource); */
NS_IMETHODIMP nsTaggingService::TagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void untagURI (in nsIURI aURI, in nsIVariant aTags, [optional] in unsigned short aSource); */
NS_IMETHODIMP nsTaggingService::UntagURI(nsIURI *aURI, nsIVariant *aTags, uint16_t aSource)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
