...
#ifndef mozilla_dom_AccessibleNodeBinding_h
#define mozilla_dom_AccessibleNodeBinding_h
...
namespace AccessibleNodeBinding {

  typedef mozilla::dom::AccessibleNode NativeType;
...
#endif // mozilla_dom_AccessibleNodeBinding_h
