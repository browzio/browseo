...
class NS_NO_VTABLE nsIDOMHTMLInputElement : public nsISupports {
 public:
  ...
  NS_IMETHOD GetMinLength(int32_t *aMinLength) = 0;
  NS_IMETHOD SetMinLength(int32_t aMinLength) = 0;
...
#define NS_DECL_NSIDOMHTMLINPUTELEMENT \
  ...
  NS_IMETHOD GetMinLength(int32_t *aMinLength) override; \
  NS_IMETHOD SetMinLength(int32_t aMinLength) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIDOMHTMLINPUTELEMENT \
  ...
  NS_METHOD GetMinLength(int32_t *aMinLength); \
  NS_METHOD SetMinLength(int32_t aMinLength); \
...
#define NS_FORWARD_NSIDOMHTMLINPUTELEMENT(_to) \
  ...
  NS_IMETHOD GetMinLength(int32_t *aMinLength) override { return _to GetMinLength(aMinLength); } \
  NS_IMETHOD SetMinLength(int32_t aMinLength) override { return _to SetMinLength(aMinLength); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLINPUTELEMENT(_to) \
  ...
  NS_IMETHOD GetMinLength(int32_t *aMinLength) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMinLength(aMinLength); } \
  NS_IMETHOD SetMinLength(int32_t aMinLength) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMinLength(aMinLength); } \
...
/* attribute long minLength; */
NS_IMETHODIMP nsDOMHTMLInputElement::GetMinLength(int32_t *aMinLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMHTMLInputElement::SetMinLength(int32_t aMinLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
