...
#define NS_IDOMWINDOWUTILS_IID_STR "c471d440-004b-4c50-a6f2-747db5f443b6"

#define NS_IDOMWINDOWUTILS_IID \
  {0xc471d440, 0x004b, 0x4c50, \
...
class NS_NO_VTABLE nsIDOMWindowUtils : public nsISupports {
 public:
  ...
  /* [optional_argc] boolean sendMouseEvent (in AString aType, in float aX, in float aY, in long aButton, in long aClickCount, in long aModifiers, [optional] in boolean aIgnoreRootScrollFrame, [optional] in float aPressure, [optional] in unsigned short aInputSourceArg, [optional] in boolean aIsDOMEventSynthesized, [optional] in boolean aIsWidgetEventSynthesized, [optional] in long aButtons); */
  NS_IMETHOD SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc, bool *_retval) = 0;
  ...
  NS_IMETHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc) = 0;
  ...
  NS_IMETHOD GetMediaSuspend(uint32_t *aMediaSuspend) = 0;
  NS_IMETHOD SetMediaSuspend(uint32_t aMediaSuspend) = 0;
  ...
  NS_IMETHOD GetElementsRestyled(uint64_t *aElementsRestyled) = 0;
...
#define NS_DECL_NSIDOMWINDOWUTILS \
  ...
  NS_IMETHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc) override; \
  ...
  NS_IMETHOD GetMediaSuspend(uint32_t *aMediaSuspend) override; \
  NS_IMETHOD SetMediaSuspend(uint32_t aMediaSuspend) override; \
  ...
  NS_IMETHOD GetElementsRestyled(uint64_t *aElementsRestyled) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIDOMWINDOWUTILS \
  ...
  NS_METHOD GetLastTransactionId(uint64_t *aLastTransactionId); \
  ...
  NS_METHOD GetContentViewerSize(uint32_t *aDisplayWidth, uint32_t *aDisplayHeight); \
  ...
  NS_METHOD SetRestoreResolution(float aResolution, uint32_t aDisplayWidth, uint32_t aDisplayHeight); \
  ...
  NS_METHOD SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc, bool *_retval); \
  ...
  NS_METHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc); \
  ...
  NS_METHOD GetSelectionAsPlaintext(nsAString & _retval); \
  ...
  NS_METHOD SendQueryContentEvent(uint32_t aType, int64_t aOffset, uint32_t aLength, int32_t aX, int32_t aY, uint32_t aAdditionalFlags, nsIQueryContentEventResult * *_retval); \
  ...
  NS_METHOD GetCurrentAudioBackend(nsAString & aCurrentAudioBackend); \
  ...
  NS_METHOD GetMillisSinceLastUserInput(double *aMillisSinceLastUserInput); \
  ...
  NS_METHOD GetMediaSuspend(uint32_t *aMediaSuspend); \
  NS_METHOD SetMediaSuspend(uint32_t aMediaSuspend); \
  ...
  NS_METHOD GetElementsRestyled(uint64_t *aElementsRestyled); \
  ...
  NS_METHOD RespectDisplayPortSuppression(bool aEnabled); \
  NS_METHOD ForceReflowInterrupt(void); \
  NS_METHOD TerminateGPUProcess(void); \
  NS_METHOD GetGpuProcessPid(int32_t *aGpuProcessPid); \
...
#define NS_FORWARD_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc, bool *_retval) override { return _to SendMouseEvent(aType, aX, aY, aButton, aClickCount, aModifiers, aIgnoreRootScrollFrame, aPressure, aInputSourceArg, aIsDOMEventSynthesized, aIsWidgetEventSynthesized, aButtons, _argc, _retval); } \
  ...
  NS_IMETHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc) override { return _to SendMouseEventToWindow(aType, aX, aY, aButton, aClickCount, aModifiers, aIgnoreRootScrollFrame, aPressure, aInputSourceArg, aIsDOMEventSynthesized, aIsWidgetEventSynthesized, aButtons, _argc); } \
  ...
  NS_IMETHOD GetMediaSuspend(uint32_t *aMediaSuspend) override { return _to GetMediaSuspend(aMediaSuspend); } \
  NS_IMETHOD SetMediaSuspend(uint32_t aMediaSuspend) override { return _to SetMediaSuspend(aMediaSuspend); } \
  ...
  NS_IMETHOD GetElementsRestyled(uint64_t *aElementsRestyled) override { return _to GetElementsRestyled(aElementsRestyled); } \
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_IMETHOD SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendMouseEvent(aType, aX, aY, aButton, aClickCount, aModifiers, aIgnoreRootScrollFrame, aPressure, aInputSourceArg, aIsDOMEventSynthesized, aIsWidgetEventSynthesized, aButtons, _argc, _retval); } \
  ...
  NS_IMETHOD SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendMouseEventToWindow(aType, aX, aY, aButton, aClickCount, aModifiers, aIgnoreRootScrollFrame, aPressure, aInputSourceArg, aIsDOMEventSynthesized, aIsWidgetEventSynthesized, aButtons, _argc); } \
  ...
  NS_IMETHOD GetMediaSuspend(uint32_t *aMediaSuspend) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMediaSuspend(aMediaSuspend); } \
  NS_IMETHOD SetMediaSuspend(uint32_t aMediaSuspend) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMediaSuspend(aMediaSuspend); } \
  ...
  NS_IMETHOD GetElementsRestyled(uint64_t *aElementsRestyled) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetElementsRestyled(aElementsRestyled); } \
...
/* readonly attribute unsigned long long lastTransactionId; */
NS_IMETHODIMP nsDOMWindowUtils::GetLastTransactionId(uint64_t *aLastTransactionId)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getContentViewerSize (out uint32_t aDisplayWidth, out uint32_t aDisplayHeight); */
NS_IMETHODIMP nsDOMWindowUtils::GetContentViewerSize(uint32_t *aDisplayWidth, uint32_t *aDisplayHeight)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void setRestoreResolution (in float aResolution, in uint32_t aDisplayWidth, in uint32_t aDisplayHeight); */
NS_IMETHODIMP nsDOMWindowUtils::SetRestoreResolution(float aResolution, uint32_t aDisplayWidth, uint32_t aDisplayHeight)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [optional_argc] boolean sendMouseEvent (in AString aType, in float aX, in float aY, in long aButton, in long aClickCount, in long aModifiers, [optional] in boolean aIgnoreRootScrollFrame, [optional] in float aPressure, [optional] in unsigned short aInputSourceArg, [optional] in boolean aIsDOMEventSynthesized, [optional] in boolean aIsWidgetEventSynthesized, [optional] in long aButtons); */
NS_IMETHODIMP nsDOMWindowUtils::SendMouseEvent(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc, bool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [optional_argc] void sendMouseEventToWindow (in AString aType, in float aX, in float aY, in long aButton, in long aClickCount, in long aModifiers, [optional] in boolean aIgnoreRootScrollFrame, [optional] in float aPressure, [optional] in unsigned short aInputSourceArg, [optional] in boolean aIsDOMEventSynthesized, [optional] in boolean aIsWidgetEventSynthesized, [optional] in long aButtons); */
NS_IMETHODIMP nsDOMWindowUtils::SendMouseEventToWindow(const nsAString & aType, float aX, float aY, int32_t aButton, int32_t aClickCount, int32_t aModifiers, bool aIgnoreRootScrollFrame, float aPressure, uint16_t aInputSourceArg, bool aIsDOMEventSynthesized, bool aIsWidgetEventSynthesized, int32_t aButtons, uint8_t _argc)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AString GetSelectionAsPlaintext (); */
NS_IMETHODIMP nsDOMWindowUtils::GetSelectionAsPlaintext(nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIQueryContentEventResult sendQueryContentEvent (in unsigned long aType, in long long aOffset, in unsigned long aLength, in long aX, in long aY, [optional] in unsigned long aAdditionalFlags); */
NS_IMETHODIMP nsDOMWindowUtils::SendQueryContentEvent(uint32_t aType, int64_t aOffset, uint32_t aLength, int32_t aX, int32_t aY, uint32_t aAdditionalFlags, nsIQueryContentEventResult * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute AString currentAudioBackend; */
NS_IMETHODIMP nsDOMWindowUtils::GetCurrentAudioBackend(nsAString & aCurrentAudioBackend)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute double millisSinceLastUserInput; */
NS_IMETHODIMP nsDOMWindowUtils::GetMillisSinceLastUserInput(double *aMillisSinceLastUserInput)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute uint32_t mediaSuspend; */
NS_IMETHODIMP nsDOMWindowUtils::GetMediaSuspend(uint32_t *aMediaSuspend)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMWindowUtils::SetMediaSuspend(uint32_t aMediaSuspend)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute unsigned long long elementsRestyled; */
NS_IMETHODIMP nsDOMWindowUtils::GetElementsRestyled(uint64_t *aElementsRestyled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void respectDisplayPortSuppression (in boolean aEnabled); */
NS_IMETHODIMP nsDOMWindowUtils::RespectDisplayPortSuppression(bool aEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void forceReflowInterrupt (); */
NS_IMETHODIMP nsDOMWindowUtils::ForceReflowInterrupt()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void terminateGPUProcess (); */
NS_IMETHODIMP nsDOMWindowUtils::TerminateGPUProcess()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute int32_t gpuProcessPid; */
NS_IMETHODIMP nsDOMWindowUtils::GetGpuProcessPid(int32_t *aGpuProcessPid)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
