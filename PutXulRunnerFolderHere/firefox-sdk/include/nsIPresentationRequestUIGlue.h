...
class NS_NO_VTABLE nsIPresentationRequestUIGlue : public nsISupports {
 public:
  ...
  NS_IMETHOD SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval) = 0;
...
#define NS_DECL_NSIPRESENTATIONREQUESTUIGLUE \
  NS_IMETHOD SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIPRESENTATIONREQUESTUIGLUE \
  NS_METHOD SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPRESENTATIONREQUESTUIGLUE(_to) \
  NS_IMETHOD SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval) override { return _to SendRequest(url, sessionId, device, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPRESENTATIONREQUESTUIGLUE(_to) \
  NS_IMETHOD SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SendRequest(url, sessionId, device, _retval); } 
...
/* nsISupports sendRequest (in DOMString url, in DOMString sessionId, in nsIPresentationDevice device); */
NS_IMETHODIMP nsPresentationRequestUIGlue::SendRequest(const nsAString & url, const nsAString & sessionId, nsIPresentationDevice *device, nsISupports * *_retval)
{
