...
class NS_NO_VTABLE amIAddonPathService : public nsISupports {
 public:
  ...
  NS_IMETHOD MapURIToAddonId(nsIURI *aURI, nsAString & _retval) = 0;
...
#define NS_DECL_AMIADDONPATHSERVICE \
  ...
  NS_IMETHOD MapURIToAddonId(nsIURI *aURI, nsAString & _retval) override; 
...
#define NS_DECL_NON_VIRTUAL_AMIADDONPATHSERVICE \
  ...
  NS_METHOD MapURIToAddonId(nsIURI *aURI, nsAString & _retval); 
...
#define NS_FORWARD_AMIADDONPATHSERVICE(_to) \
  ...
  NS_IMETHOD MapURIToAddonId(nsIURI *aURI, nsAString & _retval) override { return _to MapURIToAddonId(aURI, _retval); } 
...
#define NS_FORWARD_SAFE_AMIADDONPATHSERVICE(_to) \
  ...
  NS_IMETHOD MapURIToAddonId(nsIURI *aURI, nsAString & _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MapURIToAddonId(aURI, _retval); } 
...
/* AString mapURIToAddonId (in nsIURI aURI); */
NS_IMETHODIMP amAddonPathService::MapURIToAddonId(nsIURI *aURI, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
