...
struct RTCSessionDescriptionInit : public DictionaryBase
{
  ...
  MOZ_INIT_OUTSIDE_CTOR Nullable<RTCSdpType> mType;
...
public:
  ...
  explicit inline RTCSessionDescriptionJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }

  explicit inline RTCSessionDescriptionJSImpl(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
