...
{
	[TestFixture]
	public class nsAStringTests : TestsBase
	{
		[Test]
		...
		[Test]
		public void nsAString_Size_ReturnsValidValue()
		{
			Assert.AreEqual(nsStringContainer.Size, Marshal.SizeOf(typeof(nsStringContainer)));
		}
	}
}