...
public:
  ...
  explicit inline XPathNSResolver(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal, const FastCallbackConstructor& )
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }

  explicit inline XPathNSResolver(JS::Handle<JSObject*> aCallback, JS::Handle<JSObject*> aAsyncStack, nsIGlobalObject* aIncumbentGlobal)
...
{
public:
  explicit inline FastXPathNSResolver(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : XPathNSResolver(aCx, aCallback, aIncumbentGlobal, FastCallbackConstructor())
  {
  }
  ...
  {
    XPathNSResolver::HoldJSObjectsIfMoreThanOneOwner();
  }
};
} // namespace binding_detail
